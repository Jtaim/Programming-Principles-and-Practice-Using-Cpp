...
bool is_roman;	// a global to indicate if a roman numeral is part of a statement.
...
void calculate()        // expression evaluation loop
{
	...
	while(true)
		...
		std::cout << result;
		if(is_roman){
			std::cout << Roman_int{static_cast<int>(answer)}.as_str() << "\n";
			is_roman = false;
		} else{
			std::cout << answer << "\n";
		}
