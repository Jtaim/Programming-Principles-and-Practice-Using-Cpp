...
try
{
    ...
    GraphLib::Rectangle r{ Point{200,200}, 100, 50 };	// top left corner, width, height
    win.Attach( r );
    ...
    std::string str = std::format( "screen size : {}*{}; window size: {}*{}",
                                   Get_Width(), Get_Height(), win.Get_Width(), win.Get_Height());
