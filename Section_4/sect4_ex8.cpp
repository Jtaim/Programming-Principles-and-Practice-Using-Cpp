...
int main()
{
    ...
    std::size_t current_square_grains{ 1 };
    std::size_t previous_square_grains{ 0 };
    std::cout << "size of square in bytes = " << sizeof( current_square_grains ) << std::endl;
    std::cout << "max limit of square = " << std::numeric_limits<std::size_t>::max() << "\n\n";
