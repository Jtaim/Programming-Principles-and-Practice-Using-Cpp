...
{
  Token temp{'\0'};  // temp storage for the returns
  ...
  else
  {
    ...
    case '(': case ')': case '+': case '-': case '*': case '/':
      temp = Token(ch);       // let each character represent itself
      break;
    case '.':
    ...
    case '5': case '6': case '7': case '8': case '9':
    {
      ...
      temp = Token('8', val); // let '8' represent "a number"
      break;
    }
    default:
      error("Bad token");
